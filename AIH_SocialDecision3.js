/*:
 * @plugindesc AI Hero Framework - Social Decision System v0.2.0
 ...
 * STEP 19
 *
 * Determines what SOCIAL RESPONSE the heroine is most inclined to choose
 * after a social interaction has been objectively evaluated and subjectively
 * interpreted.
 *
 * ============================================================================
 *
 ...
 * ============================================================================
 *
 * IMPORTANT PARAMETER INTEGRATION
 *
 * This module uses the ACTUAL parameters defined by:
 *
 *     AIH_Personality.js
 *     AIH_Values.js
 *     AIH_Emotions.js
 ...
 *     comfort
 *
 * No nonexistent personality, value or emotion parameters are referenced.
 *
 * ============================================================================
 */
...
(function() {
    ...
    // =========================================================================
    //
    // Uses the exact personality implementation supplied by the project.
    //
    // AIH.Personality does not currently expose getValue(), so get() is used.
    //
    // =========================================================================
    ...
    // =========================================================================
    //
    // Uses the exact values implementation supplied by the project.
    //
    // =========================================================================
    ...
    // =========================================================================
    //
    // Uses the exact emotional-state implementation supplied by the project.
    //
    // =========================================================================
    ...
    AIH.SocialDecision._socialContext =
        function(faction) {
    ...
    AIH.SocialDecision._reputationAxis =
        function(
            faction,
            axis
        ) {
            ...
            return AIH.SocialDecision._clamp100(
                value
            );
        };
    ...
    // =========================================================================
    // NORMALIZE REPUTATION AXIS
    // =========================================================================

    AIH.SocialDecision._normalizeAxis =
        function(value) {
    ...
    // =========================================================================
    //
    // Converts all relevant systems into one normalized decision state.
    //
    // IMPORTANT:
    //
    // The fields below correspond only to parameters that actually exist in
    // the supplied Personality, Values and Emotions modules.
    //
    // =========================================================================
    ...
    // =========================================================================
    //
    // Ignore is appropriate when:
    //
    // - severity is low
    // - disrespect is low
    // - interpretation confidence is low
    // - sociability is not strongly demanding a response
    // - stress/fatigue make engagement undesirable
    //
    // =========================================================================
    ...
    AIH.SocialDecision._scoreIgnore =
        function(state) {
            ...
            score +=
                (
                    (1 - state.responsePressure.perceivedDisrespect) *
                    0.20
                );
    ...
    //     end the interaction
    //
    // It is distinct from simply ignoring the treatment.
    //
    // =========================================================================
    ...
    // =========================================================================
    //
    // Compliance is cooperation with the other party.
    //
    // It is NOT automatically cowardice or submission.
    //
    ...
    // =========================================================================
    //
    // Appeasement means attempting to smooth the interaction over.
    //
    // Relevant actual parameters:
    //
    //     sociability
    ...
    AIH.SocialDecision._scoreAppease =
        function(state) {
            ...
            score +=
                (1 - state.emotions.anger) *
                0.10;

            score +=
                (1 - state.emotions.frustration) *
                0.05;
    ...
    // =========================================================================
    //
    // Assert is the primary nonviolent boundary-setting response.
    //
    // Example:
    //
    ...
    // =========================================================================
    //
    // Confrontation is more forceful than assertion.
    //
    // It represents deliberately challenging the source.
    //
    // =========================================================================
    ...
    // =========================================================================
    //
    // Resistance means refusing to be controlled without necessarily
    // escalating socially.
    //
    // Example:
    //
    //     NPC orders her around.
    //
    //     She refuses.
    //
    // =========================================================================
    ...
    // =========================================================================
    //
    // Retaliation is deliberately difficult to reach.
    //
    // Strong contributors:
    //
    //     humiliation
    ...
    // =========================================================================
    //
    // Measures how strongly the winning decision beats the second-best
    // decision.
    //
    // =========================================================================
    ...
    // Descriptive only.
    //
    // These reasons are NOT dialogue.
    //
    // =========================================================================
    ...
    // Answers:
    //
    //     "Is there enough pressure for an active response to be preferred
    //      over ignoring the interaction?"
    //
    // =========================================================================
    ...
    //     retaliate
    //
    // It does NOT automatically trigger combat.
    //
    // =========================================================================
