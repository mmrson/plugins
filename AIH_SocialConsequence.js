/*:
 * @plugindesc AI Hero Framework - Social Action Consequence System v0.2.0
 ...
 *
 * This module produces consequence pressure and delegates actual mutations
 * only through public APIs exposed by the relevant systems.
 *
 * ============================================================================
 *
 * CONSEQUENCES
...
(function() {
    ...
    AIH.SocialConsequence._personality =
        function(
            ...
            if (
                !state ||
                !state.personality ||
                state.personality[key] === undefined
            ) {
    ...
    AIH.SocialConsequence._buildReputationPressure =
        function(action) {
            ...
            // Status sensitivity amplifies reputation consequences.
    ...
    AIH.SocialConsequence._buildInteraction =
        function(action) {
            ...
            // Threats increase escalation pressure.
            ...
            // High severity makes forceful responses more consequential.
    ...
    // =========================================================================
    //
    // Consequence pressure is calculated first.
    //
    // Actual mutation is delegated only when the destination system exposes
    ...
    //
    // It only reports whether combat pressure has crossed the threshold.
    //
    // =========================================================================
    ...
    // =========================================================================
    // GET ESCALATION PRESSURE
    // =========================================================================

    AIH.SocialConsequence.getEscalationPressure =
        function(
            consequence
        ) {
    ...
    AIH.SocialConsequence.getCombatPressure =
        function(
            consequence
        ) {
        ...
        "SocialConsequence",
        {
            ...
            getEscalationPressure:
                function(
                    ...
                    return AIH.SocialConsequence.getEscalationPressure(
                        consequence
                    );
            ...
            getCombatPressure:
                function(
                    ...
                    return AIH.SocialConsequence.getCombatPressure(
                        consequence
                    );
